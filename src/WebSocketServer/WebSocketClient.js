 ...
 * Необходимо проработать протокол общения между сервером и клиентом
 * 
 * Избавляемся от этапа сериализации/десериализации, на это явно тратится много процессорного времени
 */ 
